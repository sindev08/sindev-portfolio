...
export default function Home() {
	...
	return (
		<div className="">
			...
			<Navbar />
			<div className="fixed bottom-0 z-10 w-full px-6 py-2 border-t bg-main-dark/10 backdrop-blur-sm lg:hidden border-brand/30">
				<div className="flex flex-row flex-wrap justify-between">
					<MenuMobile name="Home" clickRef={clickHero}>
						<HomeSvg className="w-6 h-6 fill-brand/60 stroke-brand" />
					</MenuMobile>
					<MenuMobile name="About" clickRef={clickAbout}>
						<AboutSvg className="w-6 h-6 fill-brand/60 stroke-brand" />
					</MenuMobile>
					<MenuMobile name="Projects" clickRef={clickProject}>
